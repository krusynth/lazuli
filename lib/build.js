...
DirectoryIndex index.json`;
  ...
  setupModIndex() {
    var indexFile = path.join(this.modpackDir, 'index.json');
    ...
    .then((fileExists) => {
      ...
      if(fileExists) {
        var modpack = require(fs.realpathSync(indexFile));
      }
  ...
  setupVersionIndex() {
    ...
    var lockfile = require(path.join(process.cwd(), 'lazuli.lock.json'));
  ...
  setupModpackList() {
    ...
    .then((fileExists) => {
      ...
      var modpack = modpackList.modpacks[this.options.slug];
